...
df = pd.read_csv('/nethome/mrungta8/project/ProjectPURE/Mukund/cartography/dataframe_RETACRED_BERT.csv')  
...
with open('/nethome/mrungta8/project/ProjectPURE/Mukund/RE_improved_baseline/dataset/retacred_filtered_variability/train.json', "r") as fh:
    data = json.load(fh)
...
def main():
    ...
    train_file = '/nethome/mrungta8/project/ProjectPURE/Mukund/RE_improved_baseline/dataset/retacred/train.json'
    ...
    with open('dict_meta_test_map_high_variability_ngram_retacred.pkl', 'wb') as f:
        pickle.dump(dict_meta_test_map, f)
    df = create_df(dict_meta_test_map, dataset_document)
    df.to_csv('meta-learning-example_high_variability_ngram_retacred.csv', index=False)
